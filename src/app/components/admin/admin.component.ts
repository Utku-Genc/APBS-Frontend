...
import { Component, HostListener, OnDestroy, OnInit, AfterViewInit, Renderer2 } from '@angular/core';
import { NavigationEnd, Router, RouterModule } from '@angular/router';
import { Subscription, filter } from 'rxjs';

declare var $: any; // For jQuery if you're using it with Bootstrap
...
export class AdminComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private updateActiveRoute(url: string) {
    if (url.includes('/admin/')) {
      this.activeRoute = url.split('/admin/')[1];
