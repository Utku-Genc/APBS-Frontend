...
@Component({
  selector: 'utk-yonetici-ilan-juri',
  imports: [CommonModule, FormsModule, QuillModule, RouterModule, SummaryPipe],
  templateUrl: './yonetici-ilan-juri.component.html',
  styleUrl: './yonetici-ilan-juri.component.css'
})
export class YoneticiIlanJuriComponent implements OnInit {
